...
<div align="center">
  <kbd>
    <img src="https://files.catbox.moe/sb2377.jpg" href="https://github.com/PRINCE-AETHER" style="width : 250px; height : 250px">
  </kbd>
  <h3>PRINCE-AETHER</h3>
  ...
  <div>
    <kbd>
      <img href="https://github.com/PRINCE-AETHER" src="https://skillicons.dev/icons?i=html" style="width:100% height:50%">
    </kbd>
     <kbd>
      <img href="https://github.com/PRINCE-AETHER" src="https://skillicons.dev/icons?i=css" style="width:100% height:50%">
    </kbd>
     <kbd>
      <img href="https://github.com/PRINCE-AETHER" src="https://skillicons.dev/icons?i=javascript" style="width:100% height:50%">
    </kbd>
     <kbd>
      <img href="https://github.com/PRINCE-AETHER" src="https://skillicons.dev/icons?i=jquery" style="width:100% height:50%">
    </kbd>
     <kbd>
      <img href="https://github.com/PRINCE-AETHER" src="https://skillicons.dev/icons?i=nodejs" style="width:100% height:50%">
    </kbd>
  </div>
  <br>
  <kbd>
    <img href="https://github.com/PRINCE-AETHER" src="https://github-readme-activity-graph.vercel.app/graph?username=PRINCE-AETHER&theme=tokyo-night" style="width:100%; height:100%">
  </kbd>
</div>
...
Aetherz Scraper can help you scrape another website so easily ( Without Using Puppeteer, etc ) making it can run on a cloud computing platform.
Also with simple structure of the scrape response make you easier to understand 😄  
<br>
<br>
Aetherz Scraper bisa membantu mu scrape website lain dengan sangat mudah ( Tanpa Menggunakan Puppeteer, dll ) membuat ini bisa berjalan dalam suatu panel ( Server ). Juga dengan struktur respon scrape yang simple membuat kamu lebih mudah untuk mengerti 😄
...
```
git clone https://github.com/PRINCE-AETHER/Scraper.git
```
...
```
//yarn
yarn add @aetherz/scraper

//npm
npm install @aetherz/scraper
```
...
```js
// ESM
import { animeSearch } from "@aetherz/scraper";

// CommonJS
const { animeSearch } = require("@aetherz/scraper");
```
...
|     Name     | Feature                         |
| :----------: | :------------------------------ |
| Any request? | Contact me! aetherscode@gmail.com |
